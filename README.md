...
A simple React-based Weather Dashboard that allows users to search for any city and view its current weather information. This project uses the OpenWeatherMap API to fetch live weather data.
Features
